...
/**
 * Proxy dài hạn cho Narrative Planner.
 * Rewrite mặc định của Next.js thường timeout ~30–60s → HTTP 500,
 * trong khi viết bài Ollama cần 1–3 phút.
 */
...
export async function POST(req: NextRequest) {
  ...
  try {
    const upstream = await fetch(`${BACKEND_URL}/api/v1/generate_article`, {
      method: "POST",
